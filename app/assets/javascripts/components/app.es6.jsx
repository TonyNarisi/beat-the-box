    ...
    return (
      <div>
        ...
        <div className={`rules-div ${this.isActive()}`}>
          <p>Beat the Box is played with a shuffled standard deck of 52 cards. The game begins with the top 9 cards laid out in a 3 x 3 grid, with the remaining 43 cards left in the deck.</p>
